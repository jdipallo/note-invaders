...
db.songs.insert({ name: "Twinkle Twinkle Little Star", 
  melodies: [{name: "Melody1", 
              melody:[{note: 'C4', beat: 1}, {note: 'C4', beat: 1}, {note: 'G4', beat: 1}, {note: 'G4', beat: 1}, {note: 'A4', beat: 1}, {note: 'A4', beat: 1}, {note: 'G4h', beat: 2}, {note: 'F4', beat: 1}, {note: 'F4', beat: 1}, {note: 'E4', beat: 1}, {note: 'E4', beat: 1}, {note: 'D4', beat: 1},{note: 'D4', beat: 1},{note: 'C4h', beat: 2}]
             }]
})
